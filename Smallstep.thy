...
term single_valued
(* CH: So this is the proper Isabelle definition for partial_function, but
...
(* CH:  TODO - automate the above proof more.  A little tricky since it's really just manually ripping apart
        \<exists> *)
...
(* CH:  TODO - Find a cuter way to handle things other than "back" *)
