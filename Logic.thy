...
(* CH:  I'm not sure whether the Coq or Isabelle version is uglier !! *)
...
(* CH:  Equality in Isabelle is, really and truly, equality of sets. 
...
(* CH:  In Coq, when you use inversion absurd cases are automatically tossed out
...
(* CH: You're totally not allowed to write an inductive definition with
...
(* CH:  The assumption that you can prove foo x for any x is false, thus
...
(* CH:  TJC suggested I prove that your mother never loved you, btw *)
...
(* CH: It might be a good time to remind the reader to use C-c C-f intro
...
(* CH: Okay, this wasn't the most instructive proof but it was really straight
