...
(* CH: All the others basically follow the same format! *)
...
(* CH:  Isabelle has an option type as well!  It also has constructors Some and None 
...
(* CH:  A lot of the business with the apply tactic is
